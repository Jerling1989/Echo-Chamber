...
<body>
	...
	<div class="row col-md-12">
		<form action="comment_frame.php?post_id=<?php echo $post_id; ?>" id="comment_form" name="postComment<?php echo $post_id; ?>" method="POST">
			<!-- COMMENT TEXTAREA -->
			<textarea class="col-lg-10 col-md-10 col-sm-10 col-8" name="post_body"></textarea>
			<!-- COMMENT SUBMIT -->
			<input class="col-lg-2 col-md-2 col-sm-2 col-4 btn btn-success" type="submit" name="postComment<?php echo $post_id; ?>" value="Comment" />
		</form>
	</div>
	<!-- END COMMENT FORM -->
